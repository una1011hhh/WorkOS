...
export const seedData: WorkData = {
  ...
  tasks: [
    { id: "t1", title: "整理 Q2 项目复盘材料", description: "汇总目标、关键结果和复盘结论", status: "Doing", priority: "P0", projectId: "p1", requester: "林薇", source: "项目群", createdAt: day(-2), dueDate: day(1), estimatedHours: 3, actualHours: 1.8, waitingFor: "", tags: ["复盘", "交付"], notes: "重点补充渠道拆分结论。", timeTracking: tracking(1.8) },
    { id: "t2", title: "确认新版埋点方案", description: "与数据团队确认事件命名和口径", status: "Waiting", priority: "P1", projectId: "p2", requester: "自己", source: "会议", createdAt: day(-5), dueDate: day(0), estimatedHours: 1.5, actualHours: 0.8, waitingFor: "陈航 / 数据团队", waitingReason: "确认事件命名和统计口径", followUpDate: day(2), tags: ["数据"], notes: "", timeTracking: tracking(0.8) },
    { id: "t3", title: "输出客户访谈提纲", description: "覆盖使用场景、决策链与核心痛点", status: "Todo", priority: "P1", projectId: "p3", requester: "周敏", source: "私聊", createdAt: day(-1), dueDate: day(2), estimatedHours: 2, actualHours: 0, waitingFor: "", tags: ["研究"], notes: "", timeTracking: tracking() },
    { id: "t4", title: "补充周会数据看板", description: "新增转化漏斗和渠道拆分", status: "Done", priority: "P2", projectId: "p1", requester: "林薇", source: "周会", createdAt: day(-4), dueDate: day(-1), estimatedHours: 2, actualHours: 2.6, waitingFor: "", completedAt: day(-1), tags: ["数据"], notes: "渠道映射比预期复杂。", timeTracking: tracking(2.6) },
    { id: "t5", title: "预约供应商方案评审", description: "协调下周时间", status: "Inbox", priority: "P2", projectId: "", requester: "许靖", source: "邮件", createdAt: day(0), dueDate: "", estimatedHours: .5, actualHours: 0, waitingFor: "", tags: [], notes: "", timeTracking: tracking() },
    { id: "t6", title: "完成新手引导文案走查", description: "统一术语并补充异常分支", status: "Done", priority: "P1", projectId: "p4", requester: "自己", source: "产品评审", createdAt: day(-6), dueDate: day(-2), estimatedHours: 1.5, actualHours: 1.2, waitingFor: "", completedAt: day(-2), tags: ["体验"], notes: "", timeTracking: tracking(1.2) },
  ],
  meetings: [
