...
export const seedData: WorkData = {
  ...
  tasks: [
    ...
    { id: "t2", title: "确认新版埋点方案", description: "与数据团队确认事件命名和口径", status: "Waiting", priority: "P1", projectId: "p2", requester: "自己", source: "会议", createdAt: day(-5), dueDate: day(0), estimatedHours: 1.5, actualHours: 0.8, waitingFor: "陈航 / 数据团队", tags: ["数据"], notes: "", timeTracking: tracking(0.8) },
